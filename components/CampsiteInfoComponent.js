...
function RenderCampsite(props) {
    ...
    const panResponder = PanResponder.create({
        ...
        onPanResponderGrant: () => {
            ...
            // every animatable method will return a promise object at the end of the duration, and that will contain the property of finished, and will be true if animation finished successfully.
